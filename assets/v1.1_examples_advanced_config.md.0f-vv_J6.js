import{_ as s,c as i,o as a,a4 as n}from"./chunks/framework.6Bd6W3md.js";const A=JSON.parse('{"title":"了解配置","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"v1.1/examples/advanced/config.md","filePath":"v1.1/examples/advanced/config.md","lastUpdated":1721304094000}'),p={name:"v1.1/examples/advanced/config.md"},l=n(`<h1 id="了解配置" tabindex="-1">了解配置 <a class="header-anchor" href="#了解配置" aria-label="Permalink to &quot;了解配置&quot;">​</a></h1><h2 id="数据配置" tabindex="-1">数据配置 <a class="header-anchor" href="#数据配置" aria-label="Permalink to &quot;数据配置&quot;">​</a></h2><p><code>a.db.config.ts</code></p><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { AlemonOptions } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;alemonjs&#39;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div></div></div>`,6),h=[l];function k(t,e,r,d,g,y){return a(),i("div",null,h)}const E=s(p,[["render",k]]);export{A as __pageData,E as default};
